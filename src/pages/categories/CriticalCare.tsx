import { ArrowLeft, Syringe, X, MessageCircle } from 'lucide-react';
      ...
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <Syringe className="w-16 h-16 text-[#6B8E23] mx-auto mb-6" />
            <h1 className="text-5xl font-bold text-gray-800 mb-6">Critical Care Equipment</h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Life-saving critical care equipment for intensive care units and emergency medicine.
            </p>
          </div>
            ...
            {products.map((product, index) => (
              <div key={index} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all">
                <div className="w-12 h-12 bg-gradient-to-br from-[#6B8E23]/20 to-[#6B8E23]/10 rounded-lg flex items-center justify-center mb-4">
                  <Syringe className="w-6 h-6 text-[#6B8E23]" />
                </div>
                <h3 className="font-bold text-gray-800 mb-2">{product}</h3>
                <p className="text-gray-600 text-sm mb-4">Critical care equipment for life-support and emergency medical procedures.</p>
                <button 
