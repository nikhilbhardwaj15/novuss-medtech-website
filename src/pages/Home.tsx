          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                <Link to="/brochure" className="bg-gradient-to-r from-[#6B8E23] to-[#808000] hover:from-[#556B2F] hover:to-[#6B8E23] text-white px-10 py-5 font-medium transition-all flex items-center space-x-3 group shadow-2xl shadow-[#6B8E23]/40">
