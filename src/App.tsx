      ...
      <nav className="fixed w-full bg-white/80 backdrop-blur-md z-50 border-b border-gray-200 rounded-b-2xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-gradient-to-r from-[#6B8E23] to-[#808000] hover:from-[#556B2F] hover:to-[#6B8E23] text-white px-6 py-2 transition-all shadow-lg shadow-[#6B8E23]/30">
              Get Started
            </button>
          </div>
          <button 
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-md border-t border-gray-200">
            <div className="px-4 py-4 space-y-4">
              ...
              <a href="#about" className="block text-gray-700 hover:text-gray-900 transition-colors" onClick={() => setMobileMenuOpen(false)}>About</a>
              <a href="#contact" className="block text-gray-700 hover:text-gray-900 transition-colors" onClick={() => setMobileMenuOpen(false)}>Contact</a>
              <button className="w-full bg-gradient-to-r from-[#6B8E23] to-[#808000] hover:from-[#556B2F] hover:to-[#6B8E23] text-white px-6 py-3 transition-all shadow-lg shadow-[#6B8E23]/30">
                Get Started
              </button>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button className="border-2 border-gray-300 hover:border-[#6B8E23]/60 hover:bg-[#6B8E23]/10 text-gray-800 px-10 py-5 font-medium transition-all backdrop-blur-sm">
                  Schedule Demo
                </button>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <a href="#" className="text-[#6B8E23] font-semibold flex items-center space-x-2 group-hover:gap-4 transition-all">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="bg-gradient-to-br from-[#6B8E23]/20 to-white/90 p-6 sm:p-8 lg:p-10 rounded-2xl backdrop-blur-sm shadow-2xl shadow-[#6B8E23]/30">
              <form className="space-y-4 sm:space-y-6">
                ...
                <button className="w-full bg-gradient-to-r from-[#6B8E23] to-[#808000] hover:from-[#556B2F] hover:to-[#6B8E23] text-white px-6 py-4 sm:px-8 sm:py-5 font-semibold transition-all rounded-lg shadow-2xl shadow-[#6B8E23]/40 hover:shadow-[#6B8E23]/60 text-sm sm:text-base">
                  Send Message
                </button>
              </form>
            </div>
